...
✨ Responsive astrology website with dynamic zodiac-based content
⚡ Built with HTML, CSS, JavaScript

### 🔍 GitHub User Finder

🔗 Fetches GitHub user data using REST API (async/await)
⚡ Includes error handling & responsive UI
